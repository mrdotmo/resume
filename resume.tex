...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            ...
            \begin{highlights}
                \item Designed and implemented a new deployment strategy, using Android Dynamic Apps. This work improved security and decoupled our release cycle from the release cycle of the Android Core Library.  The model download success rate improved from 70% to over 90%. 
